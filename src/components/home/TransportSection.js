      ...
      <div className="grid items-center gap-5 lg:grid-cols-2 xl:gap-40 md:gap-20">
        <div className="space-y-8">
          ...
          <h1 className="text-5xl font-bold">
            We Provide <br /> Full Range Global <br /> Logistics Solution
          </h1>
        ...
        <div className="w-full space-y-8 justify-center">
          ...
          <div className="bg-[#F7F9FB] space-y-3 rounded-xl p-6">
            <div className="text-5xl font-bold text-primary_color">78291</div>
            <div className="text-gray-600">Delivered Packages</div>
          </div>
          <div className="bg-[#F7F9FB] space-y-3 rounded-xl mt-3 p-6">
            <div className="text-5xl font-bold text-primary_color">12571</div>
